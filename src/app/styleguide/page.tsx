...
/**
 * Guia de estilo — referencia interna da equipe.
 *
 * Mostra os tokens, a tipografia, a logo e os componentes base nos dois
 * temas. Serve para conferir que uma mudanca de cor nao quebrou nada em
 * outro lugar, e para quem entrar no projeto depois entender o sistema sem
 * ler o CSS.
 *
 * Fica fora do menu e fora do Google de proposito: e ferramenta de trabalho,
 * nao conteudo para cliente.
 */
    ...
    <main id="conteudo">
      <Container className="max-w-3xl py-16">
        ...
        <p className="border-t pt-6 font-mono text-xs text-muted-foreground">
          GUIA DE ESTILO — REFERÊNCIA INTERNA DA ORDEM DEV
        </p>
      </Container>
    </main>
  );
